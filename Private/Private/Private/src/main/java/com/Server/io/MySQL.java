...
public class MySQL
{
    ...
    private static final String URL_FORMAT = "jdbc:mysql://localhost:3306/ninja_school";
    ...
    public static Connection createConnection(final int connId, final String host, final String database, final String user, final String pass) {
        try {
            return MySQL.conn_map.put(connId, DriverManager.getConnection(String.format("jdbc:mysql://localhost:3306/ninja_school",host,database), user, pass));
        }
